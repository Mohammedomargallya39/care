...
class ColorsManager {
  ///Primary Colors
  static const Color primary = Color(0xff101A25);
  static const Color secondary = Color(0xff820B4B);
  static const Color thirdColor = Color(0xff1b789c);
  static const Color redPrimary = Color(0xfffd0000);
  static const Color orangePrimary = Color(0xffFFC10E);

  /// light theme
  ///
  static const Color mainColor = const Color(0xff101A25);
  static const Color secondryColor = const Color(0xff820B4B);
