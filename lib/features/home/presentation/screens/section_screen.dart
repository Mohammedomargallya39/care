          ...
          children: [
            ...
            Container(
              ...
              child: Padding(
                ...
                child: DefaultText(title: 'Sections', style: Style.medium,color: ColorsManager.white,fontWeight: FontWeight.bold,fontSize: 30.rSp),
              ),
            ),
            verticalSpace(4.h),
            Expanded(
                            ...
                            Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    DefaultText(title: 'Heart Disease', style: Style.small, fontSize: 22.rSp, color: ColorsManager.white,fontWeight: FontWeight.w600),
                                    Row(
                                      children: [
